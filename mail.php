                                      ...
                                      <tr>
                                        <td align="center" valign="top">
                                          <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            Vous avez un nouveau message: </div>
                                            <hr>
                                  <h6 style="font-size: 17px;"><b>Dù:</b><span style="font-size: 16px;">
                                  '.$_POST['nom'].' '.$_POST['prenom'].'
                                  </span>
                                   <h6 style="font-size: 17px;"><b>Email:</b><span style="font-size: 16px;">
                                  '.$_POST['email'].'
                                    </h6></span>
                                  <h6 style="font-size: 17px;"><b>Message:</b><span style="font-size: 16px;">
                                  '.$_POST['message'].'
                                      </h6></span>
                           <br>
...
if(mail("saf.call@yahoo.com","Contact Cabinet Téléassistance",$msg,$headers)){
  echo "True";
}else{
  echo "False";
}
